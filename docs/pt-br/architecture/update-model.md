...
O zero-desktop usará o **updater oficial do Tauri**:
...
Detalhes de configuração (URL do endpoint, chave pública) serão definidos posteriormente, antes do primeiro release.
